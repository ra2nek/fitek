            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex " id="routes">
                                ...
                                <NavLink :href="route('admin.meals')" :active="route().current('admin.meals')">
                                    Posiłki
                                </NavLink>
                                <NavLink :href="route('admin.dietCalendar')" :active="route().current('admin.dietCalendar')">
                                    Plan posiłków
                                </NavLink>
                                <NavLink :href="route('admin.files')" :active="route().current('admin.files')">
                                    Pliki
                                </NavLink>
                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <DropdownLink :href="route('dashboard')"> Powrót  </DropdownLink>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('admin.meals')" :active="route().current('admin.meals')">
                            Posiłki
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('admin.dietCalendar')" :active="route().current('admin.dietCalendar')">
                            Plan posiłków
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('admin.files')" :active="route().current('admin.files')">
                            Pliki
                        </ResponsiveNavLink>
